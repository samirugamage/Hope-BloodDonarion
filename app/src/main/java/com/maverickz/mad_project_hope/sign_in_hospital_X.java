...
public class sign_in_hospital_X extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sign_in_hospital_x);
        ...
        if(name!=null){
            Intent intent = new Intent(sign_in_hospital_X.this,Home_hospital.class);
        ...
        loginBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(untxt.isEmpty() || pwtxt.isEmpty()){
                    Toast.makeText(sign_in_hospital_X.this , "Please Enter Your Email or Password" , Toast.LENGTH_SHORT).show();
                }
                else
                {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            if(snapshot.hasChild(untxt)){
                                ...
                                if(getPW.equals(pwtxt)){
                                    ...
                                    editor.apply();
                                    Toast.makeText(sign_in_hospital_X.this , "Successfully Logged In" , Toast.LENGTH_SHORT).show();
                                    startActivity(new Intent(sign_in_hospital_X.this , Home_hospital.class));
                                    finish();
                                }
                                else{
                                    Toast.makeText(sign_in_hospital_X.this , "Wrong Passoword" , Toast.LENGTH_SHORT).show();
                                    pw.getText().clear();
                                }
                            }
                            else{
                                Toast.makeText(sign_in_hospital_X.this , "Hospital Not Found" , Toast.LENGTH_SHORT).show();
                            }
                        }
